...
\draw(0,0) node {though};
\draw(0,-0.5) node {};
\draw(1,0) node {they};
\draw(1,-0.5) node {};
\draw(2,0) node {are};
\draw(2,-0.5) node {};
\draw(3,0) node {renewabl};
\draw(3,-0.5) node {};
\draw(4,0) node {,};
\draw(4,-0.5) node {};
...
\draw(11,0) node {than};
\draw(11,-0.5) node {};
\draw(12,0) node {wooden};
\draw(12,-0.5) node {};
\draw(13,0) node {planks};
\draw(13,-0.5) node {};
\draw(14,0) node {,};
\draw(14,-0.5) node {};
\draw(15,0) node {and};
\draw(15,-0.5) node {};
\draw(16,0) node {require};
\draw(16,-0.5) node {};
\draw(17,0) node {2};
\draw(17,-0.5) node {};
\draw(18,0) node {sticks};
\draw(18,-0.5) node {};
\draw(19,0) node {to};
\draw(19,-0.5) node {};
\draw(20,0) node {be};
\draw(20,-0.5) node {};
\draw(21,0) node {burned};
\draw(21,-0.5) node {};
\draw(22,0) node {per};
\draw(22,-0.5) node {};
\draw(23,0) node {furnace};
\draw(23,-0.5) node {};
\draw(24,0) node {operatio};
\draw(24,-0.5) node {};
\draw(25,0) node {.};
\draw(25,-0.5) node {};
\draw(26,0) node {*};
...
\draw[thick,red,->] (5,0.2) arc(130:50:3.9);
...
\draw[thick,blue,->] (5,-0.7) arc(50:130:-3.9);
