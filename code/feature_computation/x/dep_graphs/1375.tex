...
\draw(8,0) node {be};
\draw(8,-0.5) node {};
\draw(9,0) node {burned};
\draw(9,-0.5) node {};
\draw(10,0) node {to};
\draw(10,-0.5) node {};
\draw(11,0) node {produce};
\draw(11,-0.5) node {};
\draw(12,0) node {1};
\draw(12,-0.5) node {};
\draw(13,0) node {charcoal};
\draw(13,-0.5) node {};
\draw(14,0) node {,};
\draw(14,-0.5) node {};
\draw(15,0) node {without};
\draw(15,-0.5) node {};
\draw(16,0) node {using};
\draw(16,-0.5) node {};
\draw(17,0) node {up};
\draw(17,-0.5) node {};
\draw(18,0) node {any};
