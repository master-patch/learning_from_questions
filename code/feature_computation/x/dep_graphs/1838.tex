...
\draw(11,0) node {will};
\draw(11,-0.5) node {};
\draw(12,0) node {orient};
\draw(12,-0.5) node {};
\draw(13,0) node {with};
\draw(13,-0.5) node {};
\draw(14,0) node {their};
\draw(14,-0.5) node {};
\draw(15,0) node {handles};
\draw(15,-0.5) node {};
\draw(16,0) node {inward};
\draw(16,-0.5) node {};
\draw(17,0) node {,};
\draw(17,-0.5) node {};
\draw(18,0) node {creating};
\draw(18,-0.5) node {};
\draw(19,0) node {a};
\draw(19,-0.5) node {};
\draw(20,0) node {double};
\draw(20,-0.5) node {};
\draw(21,0) node {door};
\draw(21,-0.5) node {};
\draw(22,0) node {.};
