...
\draw(10,0) node {tree};
\draw(10,-0.5) node {};
\draw(11,0) node {grows};
\draw(11,-0.5) node {};
\draw(12,0) node {if};
\draw(12,-0.5) node {};
\draw(13,0) node {a};
\draw(13,-0.5) node {};
\draw(14,0) node {glass};
\draw(14,-0.5) node {};
\draw(15,0) node {pane};
\draw(15,-0.5) node {};
\draw(16,0) node {is};
...
\draw[thick,red,->] (2,0.2) arc(130:50:10.92);
...
\draw[thick,red,->] (16,0.2) arc(130:50:5.46);
...
\draw[thick,blue,->] (2,-0.7) arc(50:130:-10.92);
...
\draw[thick,blue,->] (16,-0.7) arc(50:130:-5.46);
