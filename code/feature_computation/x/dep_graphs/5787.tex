...
\draw(4,0) node {be};
\draw(4,-0.5) node {};
\draw(5,0) node {replaced};
\draw(5,-0.5) node {};
\draw(6,0) node {with};
\draw(6,-0.5) node {};
\draw(7,0) node {lanterns};
\draw(7,-0.5) node {};
\draw(8,0) node {,};
\draw(8,-0.5) node {};
\draw(9,0) node {and};
...
\draw(10,0) node {all};
\draw(10,-0.5) node {};
\draw(11,0) node {torches};
\draw(11,-0.5) node {};
\draw(12,0) node {that};
\draw(12,-0.5) node {};
\draw(13,0) node {exist};
\draw(13,-0.5) node {};
\draw(14,0) node {already};
\draw(14,-0.5) node {};
\draw(15,0) node {in};
\draw(15,-0.5) node {};
\draw(16,0) node {saved};
\draw(16,-0.5) node {};
\draw(17,0) node {games};
\draw(17,-0.5) node {};
\draw(18,0) node {whether};
\draw(18,-0.5) node {};
\draw(19,0) node {placed};
\draw(19,-0.5) node {};
\draw(20,0) node {,};
\draw(20,-0.5) node {};
\draw(21,0) node {stored};
\draw(21,-0.5) node {};
\draw(22,0) node {or};
\draw(22,-0.5) node {};
\draw(23,0) node {in};
\draw(23,-0.5) node {};
\draw(24,0) node {inventor};
\draw(24,-0.5) node {};
\draw(25,0) node {will};
\draw(25,-0.5) node {};
\draw(26,0) node {become};
\draw(26,-0.5) node {};
\draw(27,0) node {lanterns};
\draw(27,-0.5) node {};
\draw(28,0) node {.};
\draw(28,-0.5) node {};
\draw(29,0) node {*};
