...
\draw(8,0) node {if};
\draw(8,-0.5) node {};
\draw(9,0) node {broken};
\draw(9,-0.5) node {};
\draw(10,0) node {into};
\draw(10,-0.5) node {};
\draw(11,0) node {planks};
\draw(11,-0.5) node {};
\draw(12,0) node {};
\draw(12,-0.5) node {};
\draw(13,0) node {each};
...
\draw(15,-0.5) node {};
\draw(16,0) node {makes};
\draw(16,-0.5) node {};
\draw(17,0) node {four};
\draw(17,-0.5) node {};
\draw(18,0) node {wooden};
\draw(18,-0.5) node {};
\draw(19,0) node {planks};
\draw(19,-0.5) node {};
\draw(20,0) node {,};
\draw(20,-0.5) node {};
\draw(21,0) node {and};
...
\draw(23,-0.5) node {};
\draw(24,0) node {plank};
\draw(24,-0.5) node {};
\draw(25,0) node {smelts};
\draw(25,-0.5) node {};
\draw(26,0) node {1.5};
\draw(26,-0.5) node {};
\draw(27,0) node {items};
\draw(27,-0.5) node {};
\draw(28,0) node {.};
\draw(28,-0.5) node {};
\draw(29,0) node {*};
...
\draw[thick,red,->] (16,0.2) arc(50:130:8.58);
...
\draw[thick,blue,->] (16,-0.7) arc(130:50:-8.58);
