...
\draw(5,0) node {and};
\draw(5,-0.5) node {};
\draw(6,0) node {sandston};
\draw(6,-0.5) node {};
\draw(7,0) node {are};
\draw(7,-0.5) node {};
\draw(8,0) node {needed};
\draw(8,-0.5) node {};
\draw(9,0) node {,};
\draw(9,-0.5) node {};
\draw(10,0) node {the};
\draw(10,-0.5) node {};
\draw(11,0) node {ocean};
\draw(11,-0.5) node {};
\draw(12,0) node {floor};
\draw(12,-0.5) node {};
\draw(13,0) node {is};
\draw(13,-0.5) node {};
\draw(14,0) node {a};
\draw(14,-0.5) node {};
\draw(15,0) node {great};
\draw(15,-0.5) node {};
\draw(16,0) node {source};
\draw(16,-0.5) node {};
\draw(17,0) node {of};
\draw(17,-0.5) node {};
\draw(18,0) node {both};
...
\draw[thick,red,->] (8,0.2) arc(130:50:6.24);
...
\draw[thick,blue,->] (8,-0.7) arc(50:130:-6.24);
