...
\draw(0,0) node {a};
\draw(0,-0.5) node {};
\draw(1,0) node {single};
\draw(1,-0.5) node {};
\draw(2,0) node {applicat};
\draw(2,-0.5) node {};
\draw(3,0) node {of};
\draw(3,-0.5) node {};
\draw(4,0) node {bonemeal};
\draw(4,-0.5) node {};
\draw(5,0) node {produces};
\draw(5,-0.5) node {};
\draw(6,0) node {only};
\draw(6,-0.5) node {};
\draw(7,0) node {a};
...
\draw(10,0) node {-};
\draw(10,-0.5) node {};
\draw(11,0) node {several};
\draw(11,-0.5) node {};
\draw(12,0) node {tens};
\draw(12,-0.5) node {};
\draw(13,0) node {of};
\draw(13,-0.5) node {};
\draw(14,0) node {times};
\draw(14,-0.5) node {};
\draw(15,0) node {less};
\draw(15,-0.5) node {};
\draw(16,0) node {efficien};
\draw(16,-0.5) node {};
\draw(17,0) node {than};
\draw(17,-0.5) node {};
\draw(18,0) node {using};
\draw(18,-0.5) node {};
\draw(19,0) node {that};
\draw(19,-0.5) node {};
\draw(20,0) node {bonemeal};
\draw(20,-0.5) node {};
\draw(21,0) node {on};
\draw(21,-0.5) node {};
\draw(22,0) node {a};
