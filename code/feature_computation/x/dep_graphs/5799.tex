...
\draw(0,0) node {players};
\draw(0,-0.5) node {};
\draw(1,0) node {can};
\draw(1,-0.5) node {};
\draw(2,0) node {pass};
\draw(2,-0.5) node {};
\draw(3,0) node {through};
\draw(3,-0.5) node {};
\draw(4,0) node {torches};
\draw(4,-0.5) node {};
\draw(5,0) node {,};
\draw(5,-0.5) node {};
\draw(6,0) node {and};
\draw(6,-0.5) node {};
\draw(7,0) node {therefor};
\draw(7,-0.5) node {};
\draw(8,0) node {a};
\draw(8,-0.5) node {};
\draw(9,0) node {torch};
...
\draw(16,-0.5) node {};
\draw(17,0) node {without};
\draw(17,-0.5) node {};
\draw(18,0) node {the};
\draw(18,-0.5) node {};
\draw(19,0) node {player};
\draw(19,-0.5) node {};
\draw(20,0) node {needing};
\draw(20,-0.5) node {};
\draw(21,0) node {to};
\draw(21,-0.5) node {};
\draw(22,0) node {move};
...
\draw[thick,red,->] (20,0.2) arc(50:130:0.78);
...
\draw[thick,blue,->] (20,-0.7) arc(130:50:-0.78);
