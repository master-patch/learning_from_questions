...
\draw(9,0) node {will};
\draw(9,-0.5) node {};
\draw(10,0) node {likely};
\draw(10,-0.5) node {};
\draw(11,0) node {have};
\draw(11,-0.5) node {};
\draw(12,0) node {dropped};
\draw(12,-0.5) node {};
\draw(13,0) node {saplings};
\draw(13,-0.5) node {};
\draw(14,0) node {.};
\draw(14,-0.5) node {};
\draw(15,0) node {*};
...
\draw[thick,red,->] (3,0.2) arc(130:50:7.02);
...
\draw[thick,blue,->] (3,-0.7) arc(50:130:-7.02);
