...
\draw(0,0) node {differen};
\draw(0,-0.5) node {};
\draw(1,0) node {qualitie};
\draw(1,-0.5) node {};
\draw(2,0) node {of};
\draw(2,-0.5) node {};
\draw(3,0) node {pickaxe};
\draw(3,-0.5) node {};
\draw(4,0) node {are};
\draw(4,-0.5) node {};
\draw(5,0) node {required};
\draw(5,-0.5) node {};
\draw(6,0) node {to};
\draw(6,-0.5) node {};
\draw(7,0) node {successf};
\draw(7,-0.5) node {};
\draw(8,0) node {harvest};
\draw(8,-0.5) node {};
\draw(9,0) node {certain};
\draw(9,-0.5) node {};
\draw(10,0) node {ores};
\draw(10,-0.5) node {};
\draw(11,0) node {and};
