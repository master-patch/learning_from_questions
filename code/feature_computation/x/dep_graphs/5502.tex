...
\draw(10,0) node {be};
\draw(10,-0.5) node {};
\draw(11,0) node {planted};
\draw(11,-0.5) node {};
\draw(12,0) node {under};
\draw(12,-0.5) node {};
\draw(13,0) node {water};
\draw(13,-0.5) node {};
\draw(14,0) node {blocks};
\draw(14,-0.5) node {};
\draw(15,0) node {-lrb-};
\draw(15,-0.5) node {};
...
\draw(19,0) node {and};
\draw(19,-0.5) node {};
\draw(20,0) node {still};
\draw(20,-0.5) node {};
\draw(21,0) node {yield};
\draw(21,-0.5) node {};
\draw(22,0) node {a};
\draw(22,-0.5) node {};
\draw(23,0) node {harvest};
\draw(23,-0.5) node {};
\draw(24,0) node {.};
\draw(24,-0.5) node {};
\draw(25,0) node {*};
...
\draw[thick,red,->] (8,0.2) arc(130:50:10.14);
...
\draw[thick,blue,->] (8,-0.7) arc(50:130:-10.14);
