...
\draw(8,0) node {the};
\draw(8,-0.5) node {};
\draw(9,0) node {player};
\draw(9,-0.5) node {};
\draw(10,0) node {moves};
\draw(10,-0.5) node {};
\draw(11,0) node {to};
\draw(11,-0.5) node {};
\draw(12,0) node {third-pe};
\draw(12,-0.5) node {};
\draw(13,0) node {view};
\draw(13,-0.5) node {};
\draw(14,0) node {and};
\draw(14,-0.5) node {};
\draw(15,0) node {crouches};
\draw(15,-0.5) node {};
\draw(16,0) node {,};
\draw(16,-0.5) node {};
\draw(17,0) node {the};
\draw(17,-0.5) node {};
\draw(18,0) node {string};
\draw(18,-0.5) node {};
\draw(19,0) node {will};
\draw(19,-0.5) node {};
\draw(20,0) node {not};
