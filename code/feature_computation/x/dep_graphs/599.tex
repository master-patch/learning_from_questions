...
\draw(1,0) node {is};
\draw(1,-0.5) node {};
\draw(2,0) node {recommen};
\draw(2,-0.5) node {};
\draw(3,0) node {to};
\draw(3,-0.5) node {};
\draw(4,0) node {take};
\draw(4,-0.5) node {};
\draw(5,0) node {stacks};
\draw(5,-0.5) node {};
\draw(6,0) node {of};
\draw(6,-0.5) node {};
\draw(7,0) node {bowls};
...
\draw(15,0) node {and};
\draw(15,-0.5) node {};
\draw(16,0) node {bowls};
\draw(16,-0.5) node {};
\draw(17,0) node {can};
\draw(17,-0.5) node {};
\draw(18,0) node {be};
\draw(18,-0.5) node {};
\draw(19,0) node {stacked};
\draw(19,-0.5) node {};
\draw(20,0) node {,};
\draw(20,-0.5) node {};
\draw(21,0) node {but};
\draw(21,-0.5) node {};
\draw(22,0) node {mushroom};
\draw(22,-0.5) node {};
\draw(23,0) node {stew};
\draw(23,-0.5) node {};
\draw(24,0) node {can};
...
\draw[thick,red,->] (13,0.2) arc(130:50:4.68);
...
\draw[thick,red,->] (19,0.2) arc(50:130:11.7);
\draw[thick,red,->] (22,0.2) arc(130:50:0.78);
\draw[thick,red,->] (23,0.2) arc(130:50:0.78);
\draw[thick,red,->] (24,0.2) arc(50:130:17.16);
...
\draw[thick,blue,->] (13,-0.7) arc(50:130:-4.68);
...
\draw[thick,blue,->] (19,-0.7) arc(130:50:-11.7);
\draw[thick,blue,->] (22,-0.7) arc(50:130:-0.78);
\draw[thick,blue,->] (23,-0.7) arc(50:130:-0.78);
\draw[thick,blue,->] (24,-0.7) arc(130:50:-17.16);
