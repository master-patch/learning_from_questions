...
\draw(13,0) node {from};
\draw(13,-0.5) node {};
\draw(14,0) node {falling};
\draw(14,-0.5) node {};
\draw(15,0) node {off};
\draw(15,-0.5) node {};
\draw(16,0) node {while};
\draw(16,-0.5) node {};
\draw(17,0) node {still};
\draw(17,-0.5) node {};
