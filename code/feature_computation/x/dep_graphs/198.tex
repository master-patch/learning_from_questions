...
\draw(14,0) node {can};
\draw(14,-0.5) node {};
\draw(15,0) node {safely};
\draw(15,-0.5) node {};
\draw(16,0) node {sleep};
\draw(16,-0.5) node {};
\draw(17,0) node {in};
\draw(17,-0.5) node {};
\draw(18,0) node {a};
...
\draw(19,0) node {bed};
\draw(19,-0.5) node {};
\draw(20,0) node {without};
\draw(20,-0.5) node {};
\draw(21,0) node {building};
\draw(21,-0.5) node {};
\draw(22,0) node {a};
\draw(22,-0.5) node {};
\draw(23,0) node {shelter};
\draw(23,-0.5) node {};
\draw(24,0) node {first};
\draw(24,-0.5) node {};
\draw(25,0) node {.};
\draw(25,-0.5) node {};
\draw(26,0) node {*};
...
\draw[thick,red,->] (4,0.2) arc(130:50:9.36);
...
\draw[thick,blue,->] (4,-0.7) arc(50:130:-9.36);
