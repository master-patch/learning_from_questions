...
\draw(2,0) node {has};
\draw(2,-0.5) node {};
\draw(3,0) node {expresse};
\draw(3,-0.5) node {};
\draw(4,0) node {low-prio};
\draw(4,-0.5) node {};
\draw(5,0) node {desire};
\draw(5,-0.5) node {};
\draw(6,0) node {to};
\draw(6,-0.5) node {};
\draw(7,0) node {implemen};
\draw(7,-0.5) node {};
\draw(8,0) node {tile-to-};
\draw(8,-0.5) node {};
\draw(9,0) node {support};
\draw(9,-0.5) node {};
\draw(10,0) node {so};
\draw(10,-0.5) node {};
\draw(11,0) node {when};
...
\draw(12,0) node {sand};
\draw(12,-0.5) node {};
\draw(13,0) node {comes};
\draw(13,-0.5) node {};
\draw(14,0) node {into};
\draw(14,-0.5) node {};
\draw(15,0) node {contact};
\draw(15,-0.5) node {};
\draw(16,0) node {with};
\draw(16,-0.5) node {};
\draw(17,0) node {lava};
...
\draw(19,0) node {it};
\draw(19,-0.5) node {};
\draw(20,0) node {creates};
\draw(20,-0.5) node {};
\draw(21,0) node {glass};
\draw(21,-0.5) node {};
\draw(22,0) node {.};
\draw(22,-0.5) node {};
\draw(23,0) node {*};
...
\draw[thick,red,->] (3,0.2) arc(130:50:13.26);
...
\draw[thick,blue,->] (3,-0.7) arc(50:130:-13.26);
