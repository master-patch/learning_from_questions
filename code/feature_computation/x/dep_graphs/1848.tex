...
\draw(10,0) node {the};
\draw(10,-0.5) node {};
\draw(11,0) node {plate};
\draw(11,-0.5) node {};
\draw(12,0) node {is};
\draw(12,-0.5) node {};
\draw(13,0) node {triggere};
\draw(13,-0.5) node {};
\draw(14,0) node {powering};
\draw(14,-0.5) node {};
\draw(15,0) node {the};
\draw(15,-0.5) node {};
\draw(16,0) node {underlyi};
\draw(16,-0.5) node {};
\draw(17,0) node {redstone};
\draw(17,-0.5) node {};
\draw(18,0) node {wire};
\draw(18,-0.5) node {};
\draw(19,0) node {and};
\draw(19,-0.5) node {};
\draw(20,0) node {turning};
\draw(20,-0.5) node {};
\draw(21,0) node {the};
\draw(21,-0.5) node {};
\draw(22,0) node {torch};
\draw(22,-0.5) node {};
\draw(23,0) node {off};
\draw(23,-0.5) node {};
\draw(24,0) node {.};
...
\draw[thick,red,->] (13,0.2) arc(50:130:8.58);
...
\draw[thick,blue,->] (13,-0.7) arc(130:50:-8.58);
