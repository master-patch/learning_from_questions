...
\draw(6,0) node {can};
\draw(6,-0.5) node {};
\draw(7,0) node {actually};
\draw(7,-0.5) node {};
\draw(8,0) node {be};
\draw(8,-0.5) node {};
\draw(9,0) node {bright};
\draw(9,-0.5) node {};
\draw(10,0) node {red};
\draw(10,-0.5) node {};
\draw(11,0) node {,};
...
\draw(18,0) node {is};
\draw(18,-0.5) node {};
\draw(19,0) node {often};
\draw(19,-0.5) node {};
\draw(20,0) node {found};
\draw(20,-0.5) node {};
\draw(21,0) node {under};
\draw(21,-0.5) node {};
\draw(22,0) node {the};
\draw(22,-0.5) node {};
\draw(23,0) node {surface};
\draw(23,-0.5) node {};
\draw(24,0) node {.};
\draw(24,-0.5) node {};
\draw(25,0) node {*};
...
\draw[thick,red,->] (20,0.2) arc(50:130:7.8);
...
\draw[thick,blue,->] (20,-0.7) arc(130:50:-7.8);
