...
\draw(6,0) node {more};
\draw(6,-0.5) node {};
\draw(7,0) node {readily};
\draw(7,-0.5) node {};
\draw(8,0) node {availabl};
\draw(8,-0.5) node {};
\draw(9,0) node {since};
\draw(9,-0.5) node {};
\draw(10,0) node {the};
...
\draw(11,0) node {new};
\draw(11,-0.5) node {};
\draw(12,0) node {swamp};
\draw(12,-0.5) node {};
\draw(13,0) node {biomes};
\draw(13,-0.5) node {};
\draw(14,0) node {containe};
\draw(14,-0.5) node {};
\draw(15,0) node {vine-cov};
\draw(15,-0.5) node {};
\draw(16,0) node {trees};
\draw(16,-0.5) node {};
\draw(17,0) node {with};
\draw(17,-0.5) node {};
\draw(18,0) node {several};
\draw(18,-0.5) node {};
\draw(19,0) node {mushroom};
\draw(19,-0.5) node {};
\draw(20,0) node {growing};
\draw(20,-0.5) node {};
\draw(21,0) node {undernea};
\draw(21,-0.5) node {};
\draw(22,0) node {them};
\draw(22,-0.5) node {};
\draw(23,0) node {.};
