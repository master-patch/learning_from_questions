...
\draw(2,-0.5) node {};
\draw(3,0) node {farming};
\draw(3,-0.5) node {};
\draw(4,0) node {became};
\draw(4,-0.5) node {};
\draw(5,0) node {much};
\draw(5,-0.5) node {};
\draw(6,0) node {easier};
\draw(6,-0.5) node {};
\draw(7,0) node {since};
\draw(7,-0.5) node {};
\draw(8,0) node {bone};
...
\draw(17,0) node {huge};
\draw(17,-0.5) node {};
\draw(18,0) node {mushroom};
\draw(18,-0.5) node {};
\draw(19,0) node {that};
\draw(19,-0.5) node {};
\draw(20,0) node {dropped};
\draw(20,-0.5) node {};
\draw(21,0) node {several};
\draw(21,-0.5) node {};
\draw(22,0) node {individu};
\draw(22,-0.5) node {};
\draw(23,0) node {fungi};
\draw(23,-0.5) node {};
\draw(24,0) node {when};
\draw(24,-0.5) node {};
\draw(25,0) node {harveste};
\draw(25,-0.5) node {};
\draw(26,0) node {.};
\draw(26,-0.5) node {};
\draw(27,0) node {*};
...
\draw[thick,red,->] (18,0.2) arc(130:50:5.46);
...
\draw[thick,red,->] (25,0.2) arc(50:130:3.9);
...
\draw[thick,blue,->] (18,-0.7) arc(50:130:-5.46);
...
\draw[thick,blue,->] (25,-0.7) arc(130:50:-3.9);
\end{tikzpicture}
\end{center}
