...
\draw(4,0) node {is};
\draw(4,-0.5) node {};
\draw(5,0) node {thrown};
\draw(5,-0.5) node {};
\draw(6,0) node {through};
\draw(6,-0.5) node {};
\draw(7,0) node {water};
\draw(7,-0.5) node {};
\draw(8,0) node {,};
...
\draw(10,0) node {will};
\draw(10,-0.5) node {};
\draw(11,0) node {leave};
\draw(11,-0.5) node {};
\draw(12,0) node {a};
\draw(12,-0.5) node {};
\draw(13,0) node {trail};
\draw(13,-0.5) node {};
\draw(14,0) node {of};
\draw(14,-0.5) node {};
\draw(15,0) node {bubbles};
\draw(15,-0.5) node {};
\draw(16,0) node {,};
\draw(16,-0.5) node {};
\draw(17,0) node {much};
...
\draw(18,0) node {as};
\draw(18,-0.5) node {};
\draw(19,0) node {snowball};
\draw(19,-0.5) node {};
\draw(20,0) node {and};
\draw(20,-0.5) node {};
\draw(21,0) node {arrows};
\draw(21,-0.5) node {};
\draw(22,0) node {do};
\draw(22,-0.5) node {};
\draw(23,0) node {.};
...
\draw[thick,red,->] (11,0.2) arc(130:50:8.58);
...
\draw[thick,blue,->] (11,-0.7) arc(50:130:-8.58);
