...
\draw(11,0) node {was};
\draw(11,-0.5) node {};
\draw(12,0) node {excluded};
\draw(12,-0.5) node {};
\draw(13,0) node {from};
\draw(13,-0.5) node {};
\draw(14,0) node {the};
\draw(14,-0.5) node {};
\draw(15,0) node {types};
\draw(15,-0.5) node {};
\draw(16,0) node {of};
\draw(16,-0.5) node {};
\draw(17,0) node {food};
\draw(17,-0.5) node {};
\draw(18,0) node {items};
\draw(18,-0.5) node {};
\draw(19,0) node {that};
\draw(19,-0.5) node {};
\draw(20,0) node {could};
\draw(20,-0.5) node {};
\draw(21,0) node {stack};
\draw(21,-0.5) node {};
\draw(22,0) node {in};
\draw(22,-0.5) node {};
\draw(23,0) node {the};
...
\draw[thick,red,->] (15,0.2) arc(130:50:4.68);
...
\draw[thick,blue,->] (15,-0.7) arc(50:130:-4.68);
