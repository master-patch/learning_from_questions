...
\draw(8,0) node {in};
\draw(8,-0.5) node {};
\draw(9,0) node {nether};
\draw(9,-0.5) node {};
\draw(10,0) node {ruins};
\draw(10,-0.5) node {};
\draw(11,0) node {,};
\draw(11,-0.5) node {};
\draw(12,0) node {see};
...
\draw[thick,red,->] (7,0.2) arc(50:130:4.68);
...
\draw[thick,blue,->] (7,-0.7) arc(130:50:-4.68);
