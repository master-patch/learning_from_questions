...
\draw(5,0) node {seeds};
\draw(5,-0.5) node {};
\draw(6,0) node {planted};
\draw(6,-0.5) node {};
\draw(7,0) node {in};
\draw(7,-0.5) node {};
\draw(8,0) node {farmland};
\draw(8,-0.5) node {};
\draw(9,0) node {will};
\draw(9,-0.5) node {};
\draw(10,0) node {grow};
...
\draw[thick,red,->] (5,0.2) arc(130:50:6.24);
...
\draw[thick,blue,->] (5,-0.7) arc(50:130:-6.24);
