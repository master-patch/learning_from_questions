...
\draw(10,0) node {};
\draw(10,-0.5) node {};
\draw(11,0) node {navigati};
\draw(11,-0.5) node {};
\draw(12,0) node {,};
\draw(12,-0.5) node {};
\draw(13,0) node {searchla};
\draw(13,-0.5) node {};
\draw(14,0) node {ladders};
\draw(14,-0.5) node {};
\draw(15,0) node {are};
\draw(15,-0.5) node {};
...
\draw(19,0) node {for};
\draw(19,-0.5) node {};
\draw(20,0) node {climbing};
\draw(20,-0.5) node {};
\draw(21,0) node {walls};
\draw(21,-0.5) node {};
\draw(22,0) node {either};
\draw(22,-0.5) node {};
\draw(23,0) node {vertical};
\draw(23,-0.5) node {};
\draw(24,0) node {or};
\draw(24,-0.5) node {};
\draw(25,0) node {horizont};
\draw(25,-0.5) node {};
\draw(26,0) node {.};
\draw(26,-0.5) node {};
\draw(27,0) node {*};
...
\draw[thick,red,->] (25,0.2) arc(50:130:6.24);
\draw[thick,red,->] (25,0.2) arc(50:130:6.24);
...
\draw[thick,blue,->] (25,-0.7) arc(130:50:-6.24);
\draw[thick,blue,->] (25,-0.7) arc(130:50:-6.24);
\end{tikzpicture}
\end{center}
