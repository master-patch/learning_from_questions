...
\draw(0,0) node {the};
\draw(0,-0.5) node {};
\draw(1,0) node {player};
\draw(1,-0.5) node {};
\draw(2,0) node {should};
\draw(2,-0.5) node {};
\draw(3,0) node {try};
\draw(3,-0.5) node {};
\draw(4,0) node {to};
...
\draw(8,0) node {large};
\draw(8,-0.5) node {};
\draw(9,0) node {obstruct};
\draw(9,-0.5) node {};
\draw(10,0) node {behind};
\draw(10,-0.5) node {};
\draw(11,0) node {him};
\draw(11,-0.5) node {};
\draw(12,0) node {or};
...
\draw(17,0) node {a};
\draw(17,-0.5) node {};
\draw(18,0) node {platform};
\draw(18,-0.5) node {};
\draw(19,0) node {above};
\draw(19,-0.5) node {};
\draw(20,0) node {the};
\draw(20,-0.5) node {};
...
\draw[thick,red,->] (18,0.2) arc(50:130:11.7);
...
\draw[thick,blue,->] (18,-0.7) arc(130:50:-11.7);
