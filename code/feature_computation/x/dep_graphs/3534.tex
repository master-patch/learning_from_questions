...
\draw(16,0) node {and};
\draw(16,-0.5) node {};
\draw(17,0) node {mooshroo};
\draw(17,-0.5) node {};
\draw(18,0) node {by};
\draw(18,-0.5) node {};
\draw(19,0) node {right-cl};
\draw(19,-0.5) node {};
\draw(20,0) node {on};
\draw(20,-0.5) node {};
\draw(21,0) node {their};
\draw(21,-0.5) node {};
\draw(22,0) node {udders};
\draw(22,-0.5) node {};
\draw(23,0) node {with};
\draw(23,-0.5) node {};
\draw(24,0) node {an};
\draw(24,-0.5) node {};
\draw(25,0) node {empty};
\draw(25,-0.5) node {};
\draw(26,0) node {bucket};
\draw(26,-0.5) node {};
\draw(27,0) node {.};
\draw(27,-0.5) node {};
\draw(28,0) node {*};
...
\draw[thick,red,->] (26,0.2) arc(50:130:5.46);
...
\draw[thick,blue,->] (26,-0.7) arc(130:50:-5.46);
\end{tikzpicture}
\end{center}
