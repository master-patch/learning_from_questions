...
\draw(0,0) node {in};
\draw(0,-0.5) node {};
\draw(1,0) node {abandone};
\draw(1,-0.5) node {};
\draw(2,0) node {mine};
\draw(2,-0.5) node {};
\draw(3,0) node {shafts};
\draw(3,-0.5) node {};
\draw(4,0) node {and};
\draw(4,-0.5) node {};
\draw(5,0) node {some};
...
\draw(7,0) node {of};
\draw(7,-0.5) node {};
\draw(8,0) node {strongho};
\draw(8,-0.5) node {};
\draw(9,0) node {one};
\draw(9,-0.5) node {};
\draw(10,0) node {might};
\draw(10,-0.5) node {};
\draw(11,0) node {find};
\draw(11,-0.5) node {};
\draw(12,0) node {cobwebs};
\draw(12,-0.5) node {};
\draw(13,0) node {which};
\draw(13,-0.5) node {};
\draw(14,0) node {can};
\draw(14,-0.5) node {};
\draw(15,0) node {be};
\draw(15,-0.5) node {};
\draw(16,0) node {slashed};
\draw(16,-0.5) node {};
\draw(17,0) node {with};
\draw(17,-0.5) node {};
\draw(18,0) node {a};
\draw(18,-0.5) node {};
\draw(19,0) node {sword};
\draw(19,-0.5) node {};
\draw(20,0) node {or};
\draw(20,-0.5) node {};
\draw(21,0) node {shears};
\draw(21,-0.5) node {};
\draw(22,0) node {to};
\draw(22,-0.5) node {};
\draw(23,0) node {get};
\draw(23,-0.5) node {};
\draw(24,0) node {string};
\draw(24,-0.5) node {};
\draw(25,0) node {.};
\draw(25,-0.5) node {};
\draw(26,0) node {*};
...
\draw[thick,red,->] (12,0.2) arc(130:50:3.12);
...
\draw[thick,blue,->] (12,-0.7) arc(50:130:-3.12);
