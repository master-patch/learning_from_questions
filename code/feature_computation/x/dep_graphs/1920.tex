...
\draw(0,0) node {this};
\draw(0,-0.5) node {};
\draw(1,0) node {tactic};
\draw(1,-0.5) node {};
\draw(2,0) node {may};
\draw(2,-0.5) node {};
\draw(3,0) node {be};
\draw(3,-0.5) node {};
\draw(4,0) node {useful};
\draw(4,-0.5) node {};
\draw(5,0) node {for};
\draw(5,-0.5) node {};
\draw(6,0) node {making};
\draw(6,-0.5) node {};
\draw(7,0) node {doors};
\draw(7,-0.5) node {};
\draw(8,0) node {if};
...
\draw(12,0) node {on};
\draw(12,-0.5) node {};
\draw(13,0) node {either};
\draw(13,-0.5) node {};
\draw(14,0) node {wooden};
\draw(14,-0.5) node {};
...
\draw[thick,red,->] (20,0.2) arc(50:130:12.48);
\draw[thick,red,->] (21,0.2) arc(130:50:3.12);
...
\draw[thick,blue,->] (20,-0.7) arc(130:50:-12.48);
\draw[thick,blue,->] (21,-0.7) arc(50:130:-3.12);
