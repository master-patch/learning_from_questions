...
\draw(14,0) node {that};
\draw(14,-0.5) node {};
\draw(15,0) node {dropped};
\draw(15,-0.5) node {};
\draw(16,0) node {several};
\draw(16,-0.5) node {};
\draw(17,0) node {more};
\draw(17,-0.5) node {};
\draw(18,0) node {individu};
\draw(18,-0.5) node {};
\draw(19,0) node {mushroom};
\draw(19,-0.5) node {};
\draw(20,0) node {when};
\draw(20,-0.5) node {};
\draw(21,0) node {broken};
\draw(21,-0.5) node {};
\draw(22,0) node {.};
\draw(22,-0.5) node {};
\draw(23,0) node {*};
...
\draw[thick,red,->] (13,0.2) arc(130:50:6.24);
...
\draw[thick,blue,->] (13,-0.7) arc(50:130:-6.24);
