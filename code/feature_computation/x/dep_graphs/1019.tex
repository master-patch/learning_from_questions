...
\draw(10,0) node {the};
\draw(10,-0.5) node {};
\draw(11,0) node {bucket};
\draw(11,-0.5) node {};
\draw(12,0) node {on};
\draw(12,-0.5) node {};
\draw(13,0) node {a};
\draw(13,-0.5) node {};
\draw(14,0) node {source};
\draw(14,-0.5) node {};
\draw(15,0) node {block};
\draw(15,-0.5) node {};
\draw(16,0) node {;};
\draw(16,-0.5) node {};
\draw(17,0) node {shallow};
\draw(17,-0.5) node {};
\draw(18,0) node {,};
\draw(18,-0.5) node {};
\draw(19,0) node {running};
\draw(19,-0.5) node {};
\draw(20,0) node {fluids};
\draw(20,-0.5) node {};
\draw(21,0) node {can};
\draw(21,-0.5) node {};
\draw(22,0) node {not};
...
\draw[thick,red,->] (24,0.2) arc(50:130:13.26);
...
\draw[thick,blue,->] (24,-0.7) arc(130:50:-13.26);
\end{tikzpicture}
\end{center}
