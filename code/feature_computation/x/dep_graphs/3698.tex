...
\draw(1,0) node {stew};
\draw(1,-0.5) node {};
\draw(2,0) node {became};
\draw(2,-0.5) node {};
\draw(3,0) node {easier};
\draw(3,-0.5) node {};
\draw(4,0) node {to};
\draw(4,-0.5) node {};
\draw(5,0) node {obtain};
\draw(5,-0.5) node {};
\draw(6,0) node {in};
\draw(6,-0.5) node {};
\draw(7,0) node {beta};
...
\draw(9,0) node {when};
\draw(9,-0.5) node {};
\draw(10,0) node {mushroom};
\draw(10,-0.5) node {};
\draw(11,0) node {were};
\draw(11,-0.5) node {};
\draw(12,0) node {given};
\draw(12,-0.5) node {};
\draw(13,0) node {the};
\draw(13,-0.5) node {};
\draw(14,0) node {ability};
\draw(14,-0.5) node {};
\draw(15,0) node {to};
\draw(15,-0.5) node {};
\draw(16,0) node {slowly};
\draw(16,-0.5) node {};
\draw(17,0) node {spread};
\draw(17,-0.5) node {};
\draw(18,0) node {under};
\draw(18,-0.5) node {};
\draw(19,0) node {certain};
\draw(19,-0.5) node {};
\draw(20,0) node {space};
\draw(20,-0.5) node {};
\draw(21,0) node {and};
\draw(21,-0.5) node {};
\draw(22,0) node {light};
\draw(22,-0.5) node {};
\draw(23,0) node {conditio};
\draw(23,-0.5) node {};
\draw(24,0) node {.};
\draw(24,-0.5) node {};
\draw(25,0) node {*};
