...
\draw(14,0) node {or};
\draw(14,-0.5) node {};
\draw(15,0) node {shorn};
\draw(15,-0.5) node {};
\draw(16,0) node {,};
\draw(16,-0.5) node {};
\draw(17,0) node {turning};
\draw(17,-0.5) node {};
\draw(18,0) node {the};
\draw(18,-0.5) node {};
\draw(19,0) node {mooshroo};
\draw(19,-0.5) node {};
\draw(20,0) node {into};
\draw(20,-0.5) node {};
\draw(21,0) node {a};
\draw(21,-0.5) node {};
\draw(22,0) node {normal};
\draw(22,-0.5) node {};
\draw(23,0) node {cow};
\draw(23,-0.5) node {};
\draw(24,0) node {and};
\draw(24,-0.5) node {};
\draw(25,0) node {dropping};
\draw(25,-0.5) node {};
\draw(26,0) node {red};
\draw(26,-0.5) node {};
\draw(27,0) node {mushroom};
\draw(27,-0.5) node {};
\draw(28,0) node {.};
\draw(28,-0.5) node {};
\draw(29,0) node {*};
...
\draw[thick,red,->] (25,0.2) arc(50:130:7.8);
...
\draw[thick,blue,->] (25,-0.7) arc(130:50:-7.8);
