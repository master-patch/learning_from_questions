...
\draw(15,0) node {but};
\draw(15,-0.5) node {};
\draw(16,0) node {shears};
\draw(16,-0.5) node {};
\draw(17,0) node {can};
\draw(17,-0.5) node {};
\draw(18,0) node {harvest};
\draw(18,-0.5) node {};
\draw(19,0) node {up};
\draw(19,-0.5) node {};
\draw(20,0) node {to};
...
\draw[thick,red,->] (9,0.2) arc(130:50:7.02);
...
\draw[thick,red,->] (18,0.2) arc(50:130:9.36);
...
\draw[thick,blue,->] (9,-0.7) arc(50:130:-7.02);
...
\draw[thick,blue,->] (18,-0.7) arc(130:50:-9.36);
