...
\draw(3,0) node {most};
\draw(3,-0.5) node {};
\draw(4,0) node {efficien};
\draw(4,-0.5) node {};
\draw(5,0) node {way};
\draw(5,-0.5) node {};
\draw(6,0) node {to};
\draw(6,-0.5) node {};
\draw(7,0) node {acquire};
\draw(7,-0.5) node {};
\draw(8,0) node {wool};
\draw(8,-0.5) node {};
\draw(9,0) node {from};
\draw(9,-0.5) node {};
\draw(10,0) node {sheep};
\draw(10,-0.5) node {};
\draw(11,0) node {-lrb-};
\draw(11,-0.5) node {};
\draw(12,0) node {each};
\draw(12,-0.5) node {};
\draw(13,0) node {yielding};
\draw(13,-0.5) node {};
\draw(14,0) node {2};
\draw(14,-0.5) node {};
\draw(15,0) node {-};
...
\draw[thick,red,->] (13,0.2) arc(50:130:10.14);
...
\draw[thick,blue,->] (13,-0.7) arc(130:50:-10.14);
