...
//													
CompressedBuffer& CompressedBuffer::operator= (const CompressedBuffer& _rBuffer)
{
	i_UncompressedSize = _rBuffer.i_UncompressedSize;
	Buffer::SetData (((Buffer&)_rBuffer).GetData (), _rBuffer.Length ());
	return *this;
}
