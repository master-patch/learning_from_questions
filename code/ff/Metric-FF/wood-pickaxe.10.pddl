(define
	(problem wood-pickaxe-verification)
	...
	(:init
		...
		(= (tool-id stone-pickaxe) 11)
		(= (tool-id iron-pickaxe) 12)
		(= (tool-id wood-axe) 13)
		(= (tool-id stone-axe) 14)
		(= (tool-id iron-axe) 15)
		(= (tool-id wood-hoe) 16)
		(= (tool-id stone-hoe) 17)
		(= (tool-id iron-hoe) 18)
		(= (tool-id wood-shovel) 19)
		(= (tool-id stone-shovel) 20)
		(= (tool-id iron-shovel) 21)
		(craft-empty g11)
		(craft-empty g12)
		(craft-empty g13)
		(craft-empty g21)
