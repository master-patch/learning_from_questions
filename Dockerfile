...
RUN apt-get update && apt-get install python-dev python2.7-dbg git make apt-utils libgsl0-dev libc6-dev-i386 zlib1g-dev libncurses5-dev g++ bzip2 python-pip nano emacs vim gdb cgdb -y && pip install jsonpickle colout && pip install -U nltk numpy pdb
